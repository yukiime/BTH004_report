...
# matrix: current items' situation matrix in snapsacks
...
# function: use neighbor search algorithm to find the overall maximum value and item placement
# startSolution_matrix: current items' situation matrix in snapsacks
...
def neighbourSearch_knapsack(startSolution_matrix:torch.Tensor,KNAPSACK_NUMBER:int,knapsacks_tensor:torch.Tensor,ITEM_NUMBER:int,items_matrix:torch.Tensor)->Tuple[int,torch.Tensor]:
...
def main():
    ...
    startSolution_matrix,KNAPSACK_NUMBER,knapsacks_tensor,ITEM_NUMBER,items_matrix = test_data_generator.creat_testData5()
    for i in range(KNAPSACK_NUMBER):
    ...
    print("------solution------")
    Z_valueSum,solution = neighbourSearch_knapsack(startSolution_matrix,KNAPSACK_NUMBER,knapsacks_tensor,ITEM_NUMBER,items_matrix)
